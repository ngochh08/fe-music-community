...
const CreatePostModal = ({ show, handleClose, onAddPost, user }) => {
  ...
  const mainBrown = "#5c4023"; // Màu nâu chủ đạo của bạn
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (selectedFile) {
        ...
        isVideo = selectedFile.type.startsWith("video"); // Xác định là video hay ảnh
      }
  ...
  return (
    ...
    >
      ...
      <Modal.Body className="px-3">
        {/* Phần thông tin User lấy từ props */}
        <div className="d-flex align-items-center mb-3">
          ...
          />
          <div>
            {/* Hiển thị tên thật của bạn ở đây */}
            <h6 className="m-0 fw-bold">{user?.displayName || "Người dùng"}</h6>
        ...
        <Form onSubmit={handleSubmit}>
          ...
          <Button
            ...
            style={{ backgroundColor: "#5c4023", borderRadius: "8px" }}
          >
            {loading ? (
